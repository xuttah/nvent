<#
.SYNOPSIS
  Create Office 365 Shared Mailboxes from accounts in CSV file
.DESCRIPTION
  N/A
...
Function Main { 
    ...
    $cred = Get-Credential 
    $SharedMailboxUserName = Read-Host "Enter a username for the new Shared mailbox" 
    $SharedMailboxDisplayName = Read-Host "Enter a friendly name for the new Shared mailbox" 
